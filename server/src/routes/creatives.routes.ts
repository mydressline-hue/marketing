...
import { createCreativeSchema, idParamSchema } from '../validators/schemas';
...
router.get('/fatigued', getFatiguedCreatives);
...
router.put('/:id', requirePermission('write:creatives'), validateParams(idParamSchema), updateCreative);
router.delete('/:id', requirePermission('write:creatives'), validateParams(idParamSchema), deleteCreative);
router.patch('/:id/performance', requirePermission('write:creatives'), validateParams(idParamSchema), updateCreativePerformance);
